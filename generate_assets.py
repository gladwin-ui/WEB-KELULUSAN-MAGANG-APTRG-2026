...
# ---------------------------------------------------------------------------
# Video â€” dancing shape + teks "LULUS!"
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Audio â€” urutan nada perayaan (WAV) lalu konversi ke MP3
# ---------------------------------------------------------------------------
def generate_tone(
    frequency: float,
    duration: float,
...
def _ffmpeg_executable() -> str | None:
    """Cari ffmpeg: PATH sistem â†’ imageio-ffmpeg bundle â†’ None."""
...
def convert_wav_to_mp3() -> bool:
    """Konversi WAV â†’ MP3 via ffmpeg (sistem atau imageio-ffmpeg)."""
...
def main() -> int:
    print("=" * 60)
    print(" APTRG â€” Generator Aset Media Dummy")
    print("=" * 60)
